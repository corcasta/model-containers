...
class PI05Policy(PreTrainedPolicy):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.config = config
        print(f"Oscar debug: {self.config}")
    ...
    def _preprocess_images(self, batch: dict[str, Tensor]) -> tuple[list[Tensor], list[Tensor]]:
        ...
        print(f"OSCAR-DEBUG - observation.images.base_0_rgb - batch size: {len(batch.get("observation.images.base_0_rgb"))}")
        print(f"OSCAR-DEBUG - policy image features: {self.config.image_features}")
